...
public class DateArgumentType implements ArgumentType<Optional<LocalDateTime>> {
    protected static final String DATETIME_WITHOUT_HOURS_REGEX =
            "^\\d{1,2}/\\d{1,2}/\\d{4}$"; // Example: 31/12/2019
    protected static final String DATETIME_WITHOUT_SECONDS_REGEX =
            "^\\d{1,2}/\\d{1,2}/\\d{4}T\\d{2}:\\d{2}$"; // Example: 31/12/2019T14:30
