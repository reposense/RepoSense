...
public class AuthorConfigParserTest {
    ...
    private static final Path AUTHOR_CONFIG_MULTIPLE_REPOS = loadResource(AuthorConfigParserTest.class,
            "AuthorConfigParserTest/authorconfig_multipleRepos_test.csv");
