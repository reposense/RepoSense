...
public class CommitInfoAnalyzerTest extends GitTestTemplate {
    ...
    public void analyzeCommits_duplicateAuthorsDuplicateCommits_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, DUPLICATE_AUTHORS_DUPLICATE_COMMITS_HASH, false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2021-08-03T12:53:39+08:00", config.getZoneId()),
    ...
    public void analyzeCommits_commitsWithEmptyCommitMessageTitleOrBody_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "e54ae8fdb77c6c7d2c39131b816bfc03e6a6dd44", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-07-02T12:35:46+08:00", config.getZoneId()),
                "Test 1: With message title but no body",
        ...
        expectedCommitResults.add(new CommitResult(author, "57fa22fc2550210203c2941692f69ccb0cf18252", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-07-02T12:36:14+08:00", config.getZoneId()),
    ...
    public void analyzeCommits_multipleCommitsWithCommitMessageBody_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "2eccc111e813e8b2977719b5959e32b674c56afe", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-06-19T13:02:01+08:00", config.getZoneId()),
                ">>>COMMIT INFO<<<",
                "Hi there!\n\n>>>COMMIT INFO<<<\n", null,
        ...
        expectedCommitResults.add(new CommitResult(author, "8f8359649361f6736c31b87d499a4264f6cf7ed7", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-06-19T13:03:39+08:00", config.getZoneId()),
                "[#123] Reverted 1st commit",
    ...
    public void analyzeCommits_commitsWithMultipleTags_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "62c3a50ef9b3580b2070deac1eed2b3e2d701e04", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-12-20T22:45:18+08:00", config.getZoneId()),
                "Single Tag Commit", "", new String[] {"1st"}, firstFileTypeAndContributionMap));
        expectedCommitResults.add(new CommitResult(author, "c5e36ec059390233ac036db61a84fa6b55952506", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-12-20T22:47:21+08:00", config.getZoneId()),
                "Double Tag Commit", "", new String[] {"2nd-tag", "1st-tag"}, secondFileTypeAndContributionMap));
    ...
    public void analyzeCommits_commitsWithMultipleTagsAndDifferentTimeZone_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "c5e36ec059390233ac036db61a84fa6b55952506", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2019-12-20T22:47:21+08:00", config.getZoneId()),
                "Double Tag Commit", "", new String[] {"2nd-tag", "1st-tag"},
                secondFileTypeAndContributionMap));
    ...
    public void analyzeCommits_emptyCommits_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "016ab87c4afe89a98225b96c98ff28dd4774410f", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2020-01-27T22:20:51+08:00", config.getZoneId()),
                "empty commit", "", null));
    ...
    public void analyzeCommits_mergeCommits_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "188e6afc49cafe0cf4c2a88d55e97679fa0b798b", true,
                GitDateUtil.parseGitStrictIsoDateWithZone("2023-01-31T15:08:54+08:00", config.getZoneId()),
    ...
    public void analyzeCommits_commitsWithBinaryFileContribution_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "a00c51138cbf5ab7d14f52b52abb182c8a369169", false,
                        GitDateUtil.parseGitStrictIsoDateWithZone("2020-04-06T16:41:10+08:00", config.getZoneId()),
                        "Add binary file", "", null));
    ...
    public void analyzeCommits_fileNameWithSpecialChars_success() throws Exception {
        ...
        expectedCommitResults.add(new CommitResult(author, "cfb3c8dc477cb0af19fce8bead4d278f35afa396", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2020-04-20T12:09:39+08:00", config.getZoneId()),
        ...
        expectedCommitResults.add(new CommitResult(author, "17bde492e9a80d8699ad193cf87e677341f936cc", false,
                GitDateUtil.parseGitStrictIsoDateWithZone("2020-04-20T12:17:40+08:00", config.getZoneId()),
