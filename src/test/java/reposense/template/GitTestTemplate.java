...
public class GitTestTemplate {
    protected static final Date BLAME_TEST_SINCE_DATE = TestUtil.getDate(2018, Calendar.JANUARY, 6);
    protected static final Date BLAME_TEST_UNTIL_DATE = TestUtil.getDate(2018, Calendar.MARCH, 8);
    protected static final Date MOVED_FILE_SINCE_DATE = TestUtil.getDate(2018, Calendar.JANUARY, 7);
    protected static final Date MOVED_FILE_UNTIL_DATE = TestUtil.getDate(2018, Calendar.MARCH, 9);
    protected static final Date PR_617_SINCE_DATE = TestUtil.getDate(2019, Calendar.FEBRUARY, 28);
    protected static final Date PR_617_UNTIL_DATE = TestUtil.getDate(2019, Calendar.APRIL, 29);
