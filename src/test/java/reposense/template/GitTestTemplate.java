...
public class GitTestTemplate {
    protected static final Date BLAME_TEST_SINCE_DATE = TestUtil.getDate(2018, Calendar.FEBRUARY, 6);
    protected static final Date BLAME_TEST_UNTIL_DATE = TestUtil.getEndOfDate(2018, Calendar.FEBRUARY, 8);
    protected static final Date MOVED_FILE_SINCE_DATE = TestUtil.getDate(2018, Calendar.FEBRUARY, 7);
    protected static final Date MOVED_FILE_UNTIL_DATE = TestUtil.getEndOfDate(2018, Calendar.FEBRUARY, 9);
    protected static final Date EMAIL_WITH_ADDITION_TEST_SINCE_DATE =
            TestUtil.getDate(2019, Calendar.MARCH, 28);
    protected static final Date EMAIL_WITH_ADDITION_TEST_UNTIL_DATE =
            TestUtil.getEndOfDate(2019, Calendar.MARCH, 28);
