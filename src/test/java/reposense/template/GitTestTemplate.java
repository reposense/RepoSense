...
public class GitTestTemplate {
    ...
    protected static final Date PR_617_SINCE_DATE = TestUtil.getDate(2019, Calendar.MARCH, 28);
    protected static final Date PR_617_UNTIL_DATE = TestUtil.getEndOfDate(2019, Calendar.MARCH, 28);
