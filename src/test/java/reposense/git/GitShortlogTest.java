...
public class GitShortlogTest extends GitTestTemplate {
    ...
    public void getAuthors_validRepoDateRange_success() {
        ...
        expectedAuthorList.add(new Author("eugenepeh"));
        config.setSinceDate(TestUtil.getDate(2018, Calendar.MAY, 5, TestUtil.START_OF_DAY_TIME));
        config.setUntilDate(TestUtil.getDate(2018, Calendar.MAY, 10, TestUtil.END_OF_DAY_TIME));
    ...
    public void getAuthors_validRepoDateOutOfRange_success() {
        config.setSinceDate(TestUtil.getDate(2018, Calendar.JUNE, 1, TestUtil.START_OF_DAY_TIME));
        config.setUntilDate(TestUtil.getDate(2018, Calendar.JUNE, 20, TestUtil.END_OF_DAY_TIME));
