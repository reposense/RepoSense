...
export type UrlShape = z.infer<typeof urlMap>
...
export const summarySchema = z.object({
  ...
  supportedDomainUrlMap: z.object({
    NOT_RECOGNIZED: z.object(urlMap.shape),
    github: z.object(urlMap.shape),
  }),
});
