...
window.app = new window.Vue({
  ...
  methods: {
    ...
    updateReportZip(evt) {
      ...
      if (ext != "zip") { // Reject file if it is not one of the specified filetypes
        window.alert("This is not a .zip file. Please upload the .zip file that is generated by RepoSense.");
        return;
      }
      this.users = [];
