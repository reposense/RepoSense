...
### Javascript Files
- [**main.js**](#main) - main controller that pushes content into different modules
- [**api.js**](#data-loader)- loading and parsing of the report content
- [**v_summary.js**](#summary-view) - module that supports the summary view
- [**v_authorship.js**](#authorship-view) - module that supports the authorship tab view
- [**v_zoom.js**](#zoom-view) - module that supports the zoom tab view
- [**v_ramp.js**](#ramp-view) - module that supports the ramp chart view
- [**v_segment.js**](#segment-view) - module that supports the code segment view
