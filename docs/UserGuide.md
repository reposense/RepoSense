...
Example:`--view` or `-v`
* **`--timezone, -t ZONE_ID`**: Indicates the timezone relative to UTC which will be used for the generated report. Format: `UTC[±hh[mm]]` Default: system's default timezone.<br>
