...
**Bookmarking a specific toolbar setting and code panel**: The URL changes according to the toolbar configuration and code panel viewed. You can save a specific configuration of the report by bookmarking the url (using browser functionality).
