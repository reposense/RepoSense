...
[Optional] Ignore Global List | The list of file path globs to ignore during analysis for each user. More details on the Java glob standard [here](https://javapapers.com/java/glob-with-java-nio/)
