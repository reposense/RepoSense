...
* `ignoredAuthorsList`: Instead of providing a list of all authors to analyze, a list of authors to omit can be provided. Authors should be specified by their [Git Author Name](#a-note-about-git-author-name).
...
Repository's Location|Branch|File formats|Ignore Glob List|Ignore standalone config|Ignore Commits List|Ignored Authors List
---------------------|------|------------|----------------|------------------------|-------------------
...
[Optional] Ignored Authors List<sup>*+</sup> | The list of authors to ignore during analysis. Authors should be specified by their [Git Author Name](#a-note-about-git-author-name).
