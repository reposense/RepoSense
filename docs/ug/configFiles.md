...
| Since Date                            | Enter since date in the format of `dd/mm/yyyy` to signify the start date of analysis. If the field is ignored, the date will be set to the default one or the date indicated in CLI flags                                                                                                                                                               |
| Until Date                            | Enter until date in the format of `dd/mm/yyyy` to signify the end date of analysis. If the field is ignored, the date will be set to the default one or the date indicated in CLI flags                                                                                                                                                                   |
