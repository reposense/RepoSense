...
* **If you have Java on your computer**, the straightforward way to generate a report is to use the RepoSense executable to generate the report locally in your computer, as explained in the [_Generating reports locally_](#generating-reports-locally) section below.

* **If you don't have Java on your computer or do not wish to run the executable in your computer**, some alternatives are provided in the [_Generating a report remotely_](#generating-reports-remotely) section below.
...
**You can generate a RepoSense report remotely, without installing/running anything in your computer.** This is particularly useful when you are just trying to decide whether to adopt RepoSense.
