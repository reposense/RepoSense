...
**You can generate a RepoSense report remotely, without installing/running anything in your computer.** This is particularly useful when you are deciding whether to adopt RepoSense.
