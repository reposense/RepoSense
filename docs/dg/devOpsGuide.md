...
There is a manual action named `GitHub Actions preview build manual`. It takes in an input of the PR number and run the test on the branch referring to the PR.
