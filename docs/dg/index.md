...
**Please go [here](https://reposense.github.io/RepoSense/dg/index.html) for the version matching the latest `master` branch.**
</span>
</box>
</span>
...
Optionally, you can follow the [Checkstyle tutorial at se-edu/guides](https://se-education.org/guides/tutorials/checkstyleTutorial.html) to configure *Intellij* to check style-compliance as you write code.
...
### Before writing code
1. Do check out our [process guide]({{baseUrl}}/dg/process.html) before submitting any PR with your changes.
