...
* Although it is unnecessary to write a detailed commit message, each PR is still recommended to contain a brief commit message in its description. The guideline is available [here](https://se-education.org/guides/guidelines/PRs.html).
