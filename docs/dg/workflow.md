...
* Although it is no necessary to write elaborate commit message, it is still recommended for each PR to contain a brief commit message in its description. The guideline is available [here](https://se-education.org/guides/guidelines/PRs.html).
